...
public enum ErrorCode {
  ...
  ALREADY_PARTICIPATE_ROOM(112, "이미 참여된 방입니다.", 400),
  NOT_ALLOW_RESERVATION_REQUEST(113, "방 예약과 관련된 시간이 아닙니다.", 400),
  ALREADY_RESERVATION_ROOM(114, "이미 예약한 방입니다.", 400),
  REQUIRE_RESERVATION_ROOM(115, "예약된 유저가 아닙니다,", 400),
  NOT_ALLOW_HOST_USER_REQUEST(116, "방장은 해당 요청을 보낼 수 없습니다.", 400),
  NOT_ALLOW_JOIN_REQUEST(117, "방 참여와 관련된 시간이 아닙니다.", 400),
  ALREADY_JOIN_ROOM(118, "이미 참여한 방입니다.", 400),
  REQUIRE_JOIN_ROOM(119, "참여한 유저가 아닙니다.", 400),
  LIMIT_ROOM_USER_COUNT(120, "방이 최대 인원입니다.", 400),
  NOT_DELETE_ROOM_TIME(121, "방 삭제를 할 수 없는 시간입니다.", 400),
